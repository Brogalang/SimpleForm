...
<div class="container-fluid jarak-header">
    <h2 style="color:grey; text-align:center;">Form Register</h2><br>
    ...
    <div class="input-group" id="show_hide_passwordConf"><input class="form-control" type="password" name="confpassword" id="InputForConfPassword" placeholder="Masukan Confirm Password">
    <div class="input-group-addon">
        <a style="color:#333;" href="#"><i class="glyphicon glyphicon-eye-close" aria-hidden="true"></i></a>
    </div>
    </input>
...
<p>Sudah Punya Akun ?
    <button type="button" onclick="window.location.href='/login'" class="btn btn-success">Masuk Disini <i class="glyphicon glyphicon-user"></i></button>
</p>
</div>
